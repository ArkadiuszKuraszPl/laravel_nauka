...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('shop.product.edit_title', ['name' => $user->name]) }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="row mb-3">
                            <label for="street_no" class="col-md-4 col-form-label text-md-end">Numer domu</label>
                        ...
                        <div class="row mb-3">
                            <label for="home_no" class="col-md-4 col-form-label text-md-end">Numer mieszkania</label>
